...
(function() {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.set_default_values = function() {
            ...
            this.search_contains = this.options.search_contains!=false && true;
        ...
        AbstractChosen.prototype.container_width = function() {
            if (this.options.width != null) {
                ...
                return "" + parseInt(this.form_field.offsetWidth + 2) + "px";
            }
        };
    ...
    Chosen = (function(_super) {
        ...
        Chosen.prototype.set_up_html = function() {
            ...
            this.form_field_jq.attr('style','position:absolute;margin-top:20px;clip:rect(0,0,0,0)').after(this.container);
