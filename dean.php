...
<body style="min-width: 1348px">
  <div id="header">
    ...
    <div id="header_text">Academic Schedule</div>
  </div>
    ...
    <div class="tableContainer">
      ...
      <div id="backup">
        ...
        <form method="get" action="backup.php" class="submit" style="font-weight: bold">
          ...
          <span style="color:#555;font-size: 15px">Backup:</span> download a snapshot of the Academic Schedule database that can be restored later :&nbsp;
      ...
      <div id="footer" style="position: relative">Powered by <a href="https://www.sonatech.ac.in/mca/" target="_blank">MCA 2019 - 21 Batch</a></div>
    </div>
